...
const {base64ToBase64url} = require("./PAver2/hashLibrary");
function sleep(ms) {
...
async function getPayloadByMethodRoute(config,method,authToken,hmac,fapiInteractionId,idempotencyKey,domesticConsentId,ASPSPsession) {
    ...
    switch (method) {
        ...
        case "GETconsentsList/PSUorPAU":
            ...
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents?fromCreationDate=2025-11-21&toCreationDate=2025-12-16&type=domesticTaxConsent",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
        ...
        case "GETconsentsList":
            ...
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents?fromCreationDate=2023-05-16&toCreationDate=2025-10-30\"",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
        ...
        case "GETconsentStatusDBO":
            ...
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/domestic/"+domesticConsentId+"/PSUorPAU/PISP2TEST",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
        ...
        case "DELETEpaymentConsents/instant":
            ...
            break
        case "GETpaymentsInstant":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/instant/"+domesticConsentId,
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
        ...
        case "DELETEpaymentConsentsDomesticTaxDBO":
            ...
            break
        case "POSTpaymentsDomesticTax":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "POST",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/domesticTax",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "content-type": "application/json;charset=utf-8",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
            ...
            break
        case "GETpaymentsDomesticTaxDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/domesticTax/"+domesticConsentId +"/PSUorPAU/V087_TEST1",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
            ...
            break
        case "GETpaymentsDomesticTax":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/domesticTax/"+domesticConsentId,
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
            ...
            break
        case "DELETEpaymentsDomesticTaxDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "DELETE",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/domesticTax/"+domesticConsentId +"/PSUorPAU/V087_TEST1",
            ...
            break
        case "DELETEpaymentsDomesticTax":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "DELETE",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/domesticTax/"+domesticConsentId,
            ...
            break
        case "POSTpaymentConsentslistAccounts":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "POST",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/listAccounts",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "content-type": "application/json;charset=utf-8",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
            ...
            break
        case "GETpaymentConsentslistAccounts":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/listAccounts/"+domesticConsentId,
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
            ...
            break
        case "GETpaymentConsentslistAccountsDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/listAccounts/"+domesticConsentId +"/PSUorPAU/V087_TEST1",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
            ...
            break
        case "PATCHpaymentConsentslistAccounts":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "PATCH",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/listAccounts",
            ...
            break
        case "PUTpaymentConsentsCreateExternalRepresentationlistAccounts":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "PUT",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/listAccounts/createExternalRepresentation",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "content-type": "application/json;charset=utf-8",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
            ...
            break
        case "PUTpaymentConsentsExternalRepresentationSpecialPartlistAccounts":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "PUT",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/createSpecialPartExternalRepresentation",
            ...
            break
        case "DELETEpaymentConsentslistAccounts":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "DELETE",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/listAccounts/"+domesticConsentId,
            ...
            break
        case "DELETEpaymentConsentslistAccountsDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "DELETE",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/listAccounts/"+domesticConsentId + "/PSUorPAU/V087_TEST1",
            ...
            break
        case "POSTpaymentslistAccounts":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "POST",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/listAccounts",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "content-type": "application/json;charset=utf-8",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
            ...
            break
        case "GETpaymentslistAccountsDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/listAccounts/"+domesticConsentId +"/PSUorPAU/V087_TEST1",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
            ...
            break
        case "GETpaymentslistAccounts":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/listAccounts/"+domesticConsentId,
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
            ...
            break
        case "DELETEpaymentslistAccountsDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "DELETE",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/listAccounts/"+domesticConsentId +"/PSUorPAU/V087_TEST1",
            ...
            break
        case "DELETEpaymentslistAccounts":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "DELETE",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/listAccounts/"+domesticConsentId,
        ...
        case "POSTpaymentConsentslistPassports":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "POST",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/listPassports",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "content-type": "application/json;charset=utf-8",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
            ...
            break
        case "GETpaymentConsentslistPassports":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/listPassports/"+domesticConsentId,
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
            ...
            break
        case "GETpaymentConsentslistPassportsDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/listPassports/"+domesticConsentId +"/PSUorPAU/V087_TEST1",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
            ...
            break
        case "PATCHpaymentConsentslistPassports":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "PATCH",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/listPassports",
            ...
            break
        case "PUTpaymentConsentsCreateExternalRepresentationlistPassports":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "PUT",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/listPassports/createExternalRepresentation",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "content-type": "application/json;charset=utf-8",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
            ...
            break
        case "PUTpaymentConsentsExternalRepresentationSpecialPartlistPassports":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "PUT",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/createSpecialPartExternalRepresentation",
            ...
            break
        case "DELETEpaymentConsentslistPassports":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "DELETE",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/listPassports/"+domesticConsentId,
            ...
            break
        case "DELETEpaymentConsentslistPassportsDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "DELETE",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/listPassports/"+domesticConsentId + "/PSUorPAU/V087_TEST1",
            ...
            break
        case "POSTpaymentslistPassports":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "POST",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/listPassports",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "content-type": "application/json;charset=utf-8",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
            ...
            break
        case "GETpaymentslistPassportsDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/listPassports/"+domesticConsentId +"/PSUorPAU/V087_TEST1",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
            ...
            break
        case "GETpaymentslistPassports":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/listPassports/"+domesticConsentId,
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
            ...
            break
        case "DELETEpaymentslistPassportsDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "DELETE",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/listPassports/"+domesticConsentId +"/PSUorPAU/V087_TEST1",
            ...
            break
        case "DELETEpaymentslistPassports":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "DELETE",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/listPassports/"+domesticConsentId,
        ...
        case "POSTpaymentConsentsRequirement":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "POST",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/requirement",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "content-type": "application/json;charset=utf-8",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
            ...
            break
        case "GETpaymentConsentsRequirement":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/requirement/"+domesticConsentId,
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
            ...
            break
        case "GETpaymentConsentsRequirementDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/requirement/"+domesticConsentId +"/PSUorPAU/V087_TEST1",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
            ...
            break
        case "PATCHpaymentConsentsRequirement":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "PATCH",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/requirement",
            ...
            break
        case "PUTpaymentConsentsCreateExternalRepresentationRequirement":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "PUT",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/requirement/createExternalRepresentation",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "content-type": "application/json;charset=utf-8",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
            ...
            break
        case "PUTpaymentConsentsExternalRepresentationSpecialPartRequirement":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "PUT",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/createSpecialPartExternalRepresentation",
            ...
            break
        case "DELETEpaymentConsentsRequirement":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "DELETE",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/requirement/"+domesticConsentId,
            ...
            break
        case "DELETEpaymentConsentsRequirementDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "DELETE",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/requirement/"+domesticConsentId + "/PSUorPAU/V087_TEST1",
            ...
            break
        case "POSTpaymentsRequirement":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "POST",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/requirement",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "content-type": "application/json;charset=utf-8",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
            ...
            break
        case "GETpaymentsRequirementDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/requirement/"+domesticConsentId +"/PSUorPAU/V087_TEST1",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
            ...
            break
        case "GETpaymentsRequirement":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/requirement/"+domesticConsentId,
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
            ...
            break
        case "DELETEpaymentsRequirementDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "DELETE",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/requirement/"+domesticConsentId +"/PSUorPAU/V087_TEST1",
            ...
            break
        case "DELETEpaymentsRequirement":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "DELETE",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/requirement/"+domesticConsentId,
        ...
        case "POSTpaymentConsentsTaxRequirement":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "POST",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/taxRequirement",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "content-type": "application/json;charset=utf-8",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
            ...
            break
        case "GETpaymentConsentsTaxRequirement":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/taxRequirement/"+domesticConsentId,
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
            ...
            break
        case "GETpaymentConsentsTaxRequirementDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/taxRequirement/"+domesticConsentId +"/PSUorPAU/V087_TEST1",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
            ...
            break
        case "PATCHpaymentConsentsTaxRequirement":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "PATCH",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/taxRequirement",
            ...
            break
        case "PUTpaymentConsentsCreateExternalRepresentationTaxRequirement":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "PUT",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/taxRequirement/createExternalRepresentation",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "content-type": "application/json;charset=utf-8",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
            ...
            break
        case "PUTpaymentConsentsExternalRepresentationSpecialPartTaxRequirement":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "PUT",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/createSpecialPartExternalRepresentation",
            ...
            break
        case "DELETEpaymentConsentsTaxRequirement":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "DELETE",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/taxRequirement/"+domesticConsentId,
            ...
            break
        case "DELETEpaymentConsentsTaxRequirementDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "DELETE",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/taxRequirement/"+domesticConsentId + "/PSUorPAU/V087_TEST1",
            ...
            break
        case "POSTpaymentsTaxRequirement":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "POST",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/taxRequirement",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "content-type": "application/json;charset=utf-8",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
            ...
            break
        case "GETpaymentsTaxRequirementDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/taxRequirement/"+domesticConsentId +"/PSUorPAU/V087_TEST1",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
            ...
            break
        case "GETpaymentsTaxRequirement":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/taxRequirement/"+domesticConsentId,
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
            ...
            break
        case "DELETEpaymentsTaxRequirementDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "DELETE",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/taxRequirement/"+domesticConsentId +"/PSUorPAU/V087_TEST1",
            ...
            break
        case "DELETEpaymentsTaxRequirement":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "DELETE",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/taxRequirement/"+domesticConsentId,
        ...
        case "POSTpaymentConsentsVRP":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "POST",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/VRP",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "content-type": "application/json;charset=utf-8",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
            ...
            break
        case "GETpaymentConsentsVRP":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/VRP/"+domesticConsentId,
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
            ...
            break
        case "GETpaymentConsentsVRPDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/VRP/"+domesticConsentId +"/PSUorPAU/V087_TEST1",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
        ...
        case "PATCHpaymentConsentsVRP":
            ...
            break
        case "PUTpaymentConsentsCreateExternalRepresentationVRP":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "PUT",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/VRP/createExternalRepresentation",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "content-type": "application/json;charset=utf-8",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
            ...
            break
        case "PUTpaymentConsentsExternalRepresentationSpecialPartVRP":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "PUT",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/createSpecialPartExternalRepresentation",
        ...
        case "DELETEpaymentConsentsVRP":
            ...
            break
        case "DELETEpaymentConsentsVRPDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "DELETE",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/VRP/"+domesticConsentId + "/PSUorPAU/V087_TEST1",
            ...
            break
        case "POSTpaymentsVRP":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "POST",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/VRP",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "content-type": "application/json;charset=utf-8",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
            ...
            break
        case "GETpaymentsVRPDBO":
            body = authType == "OBclientCredentials" ? {
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/VRP/"+domesticConsentId +"/PSUorPAU/V087_TEST1",
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
        ...
        case "GETpaymentsVRP":
            ...
            "pars": {
                "@method": "GET",
                "@target-uri": config.url_swagger + "oapi-channel/open-banking/v1.0/payments/VRP/"+domesticConsentId,
                "authorization": "Bearer "+ authToken,
                "content-digest": "belt-hash256=:"+ hmac +":",
                "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
                "x-fapi-customer-ip-address": "192.168.247.72",
...
async function createPaymentConsent(config,access_token){
    let requestBodyName = "paymentConsents/domestic4.1"
...
async function getConsentListDBO(config,access_token,consentId){
    ...
    let headersList ={
      ...
      'Authorization': 'Bearer '+ access_token,
      'Accept-Language': 'ru',
      "fromCreationDate":"2023-11-21",
      "toCreationDate":"2025-12-16",
      "x-fapi-auth-date": unixDate.getFormattedDate(unixDate.getDateNsecondsAgo(600)),
      "x-fapi-customer-ip-address": "192.168.247.72",
      "x-fapi-interaction-id": fapiInteractionId,
      "x-jws-signature": signature,
    ...
    const response = await fetch(config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/PSUorPAU/V087_TEST1?fromCreationDate=2025-11-21&toCreationDate=2025-12-16&type=domesticTaxConsent", {
    method: "GET",
    mode: "cors",
    headers: headersList,
  });
...
async function getConsentList(config,access_token,consentId = "NotUsedId"){
    let requestBody = ""
    let cryptoHashBody
    if(requestBody!= ""){
        cryptoHashBody = {
    ...
    console.log(JSON.stringify(headersList))
    await appendToDefinedFile("logs.txt","accListPayments_headers",JSON.stringify(headersList))
    const response = await fetch(config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents?fromCreationDate=2025-11-21&toCreationDate=2025-11-21", {
    method: "GET",
    mode: "cors",
    headers: headersList,
  });
...
async function deletePaymentConsentsDomesticDBO(config,access_token,consentId){
    ...
    console.log(JSON.stringify(headersList))
    await appendToDefinedFile("logs.txt","DELETEconsentDomestic",JSON.stringify(headersList))
    const response = await fetch(config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/domestic/"+consentId + "/PSUorPAU/PISPTEST", {
    method: "DELETE",
    mode: "cors",
    headers: headersList,
  });
...
async function authorisePayment(config,access_token,accList){
    ...
    await appendToDefinedFile("logs.txt","headersList",JSON.stringify(headersList))
    console.log(JSON.stringify(headersList))
    // await deletePaymentConsentsDomestic(config,access_token,accList.data.paymentConsentId)
    const response = await fetch(config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/domestic", {
        method: "PATCH",
        mode: "cors",
        headers: headersList,
...
async function generatePayloadNew(config,method,authToken,fapiInteractionId,idempotencyKey,requestBodyName,domesticConsentId,projectName = "pispAuth"){
    let requestBody = ""
    if (requestBodyName){
...
async function generateSignatureGETconsentsListDBO(config,method,token,fapiInteractionId,idempotencyKey,domesticConsentId,additionalInfo = []){
    ...
    console.log("Header \r\n" +JSON.stringify(header))
    let payload = await generatePayload(config,method,token,fapiInteractionId,idempotencyKey)
    payload["pars"]["@target-uri"] = config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/PSUorPAU/V087_TEST1?fromCreationDate=2025-11-21&toCreationDate=2025-12-16&type=domesticTaxConsent"
    await appendToDefinedFile("logs.txt","payloadPars",JSON.stringify(payload))
    console.log("Payload \r\n" +JSON.stringify(payload))
    let headerB64 = convertToBase64URL(JSON.stringify(header))
    let payloadB64 = convertToBase64URL(JSON.stringify(payload))
...
async function generateSignatureGETconsentsList(config,method,token,fapiInteractionId,idempotencyKey,domesticConsentId,additionalInfo = []){
    ...
    console.log("Header \r\n" +JSON.stringify(header))
    let payload = await generatePayload(config,method,token,fapiInteractionId,idempotencyKey)
    payload["pars"]["@target-uri"] = config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents?fromCreationDate=2025-11-21&toCreationDate=2025-11-21"
    await appendToDefinedFile("logs.txt","payloadPars",JSON.stringify(payload))
    console.log("Payload \r\n" +JSON.stringify(payload))
    let headerB64 = convertToBase64URL(JSON.stringify(header))
    let payloadB64 = convertToBase64URL(JSON.stringify(payload))
...
async function generateSignatureGETConsentStatusDBO(config,method,token,fapiInteractionId,idempotencyKey,domesticId,additionalInfo = []){
    ...
    payload["pars"]["@target-uri"] = config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/domestic/"+domesticId+"/PSUorPAU/V087_TEST1"
    await appendToDefinedFile("logs.txt","payloadPars",JSON.stringify(payload))
    console.log("Payload \r\n" +JSON.stringify(payload))
    let headerB64 = convertToBase64URL(JSON.stringify(header))
    let payloadB64 = convertToBase64URL(JSON.stringify(payload))
...
async function generateSignatureDELETEConsentDomesticDBO(config,method,token,fapiInteractionId,idempotencyKey,domesticConsentId,additionalInfo = []){
    ...
    console.log("Header \r\n" +JSON.stringify(header))
    let payload = await generatePayload(config,method,token,fapiInteractionId,idempotencyKey,false,domesticConsentId)
    payload["pars"]["@target-uri"] = config.url_swagger + "oapi-channel/open-banking/v1.0/paymentConsents/domestic/"+domesticConsentId + "/PSUorPAU/PISPTEST"
    await appendToDefinedFile("logs.txt","payloadPars",JSON.stringify(payload))
    console.log("Payload \r\n" +JSON.stringify(payload))
    let headerB64 = convertToBase64URL(JSON.stringify(header))
    let payloadB64 = convertToBase64URL(JSON.stringify(payload))
...
async function main1() {
  ...
  //   await appendToDefinedFile("logs.txt","instantConsentCreate_response",JSON.stringify(generatedURLforPatch))
    ...
    // let consentCreateResponse = {"data":{"charge":[],"creationDateTime":"2025-11-27T11:18:30.041606294+03:00","domesticConsentId":"55414bf2-df71-4968b38b-6dbc02a9fe93","initiation":{"amount":"7.00","creditor":{"countryOfResidence":"BY","name":"Имечно бенефициара","organisationIdentification":[{"code":"TXID","identification":"INI200676206"}],"postalAddress":{"addressLine":[],"country":"BY"},"privateIdentification":[]},"creditorAccount":{"identification":"BY44MMBN30124040900109330000","schemeName":"BY.NBRB.IBAN"},"creditorAgent":{"identification":"AKBBBY2X","name":"ОАО 'АСБ Беларусбанк'"},"currency":"BYN","debtor":{"contactDetails":{"emailAddress":"V087_TEST1@V087_TEST1.info","faxNumber":"+375-17123456780","mobileNumber":"+375-29123456789","name":"Тестовая Тест","phoneNumber":"+375-17123456789"},"countryOfResidence":"BY","name":"ОАО \"Клиент для Open API 2 ИД 217 УНП 100218304\"","organisationIdentification":[{"code":"TXID","identification":"INN100218304"}],"postalAddress":{"addressLine":["220000, Республика Беларусь, г. МИНСК, ул. Такая-то, д.6 кв. 13","СОАТО 5000000000"],"buildingNumber":"6","country":"BY","countrySubDivision":"МИНСК","districtName":"МИНСК","postCode":"220000","room":"13","streetName":"ул. Такая-то","townLocationName":"5000000000","townName":"г. МИНСК"},"privateIdentification":[]},"debtorAccount":{"identification":"BY63AKBB36049000027730000000","schemeName":"BY.NBRB.IBAN"},"debtorAgent":{"identification":"AKBBBY2X","name":"ОАО 'АСБ Беларусбанк'"},"enclosedFile":[],"endToEndIdentification":"01.20240701.b61ba7886c1754f3","instructionIdentification":"795SDBO20240831C2876BC9BC1A41FEA5C4","listAccounts":[],"listPassportData":[],"localInstrument":"BY.NBRB.BISS.NORMAL","regulatoryReporting":[],"remittanceInformation":{"categoryPurposeCode":"OTHR","proprietaryPurpose":"190401.21","referredDocument":[],"unstructured":"1Назначение платежа в неструктурированной виде длиной 140 символов 12Назначение платежа в неструктурированной виде длиной 140 символов 23Назначение платежа в неструктурированной виде длиной 140 символов 3"},"requestedExecutionDate":"2024-08-31"},"link":"https://sc-map-testversion-vip.softclub.by:8008/auth/realms/SCRealm/protocol/openid-connect/auth?client_id=PISPTEST","status":"AwaitingAuthorisation","statusUpdateDateTime":"2025-11-27T11:18:30.041606294+03:00"},"links":{"self":"https://open-banking-akbb.softclub.by/oapi-channel/open-banking/v1.0/paymentConsents/domestic/55414bf2-df71-4968b38b-6dbc02a9fe93"},"meta":{"totalPages":1},"risk":{"paymentContextCode":"90401"}}
...
module.exports = {generatePayloadNew,sortObjectAlphabetically,sortObjectAlphabeticallyNew,getRequestBody,appendToDefinedFile,generateSignature,convertToBase64,scCryptoHash,generateHeader,generatePayload,convertToBase64URL,convertBase64UrlToBase64,scCryptoSign,createTokenPISP,UnixDate,convertBase64ToBase64Url,setAuthType,createDboClientToken,authType,getAccListPayments,createImitationInsert,createSpecialPartObject,createExternalRepresentationSpecialPart,renameKeyInObject,createExternalRepresentation,generateRandomHex,getAccListPaymentsKEYCLOAKcheck,getAccListPaymentsKEYCLOAK}
